...
export default function About() {
  return (
    <>
      <Head>
        <title>About Kappa Theta Pi - Virginia Tech</title>
        <meta name="description" content="Learn about Kappa Theta Pi at Virginia Tech, our mission, values, and members." />
        <meta property="og:title" content="About Kappa Theta Pi - Virginia Tech" />
        <meta property="og:description" content="Learn about Kappa Theta Pi at Virginia Tech, our mission, values, and members." />
      ...
      <section className="min-h-screen flex flex-col items-center justify-center px-6 py-12">
        <div className="max-w-7xl mx-auto w-full">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start mb-12">
            ...
            <div className="order-2 lg:order-2">
              <div className="max-w-full">
                <Image
                  src="/group_photo.jpg"
                  alt="Group Photo of All KTP Members at Virginia Tech"
                  width={800}
                  height={600}
          ...
          <div className="mt-16">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0049ba] mb-8 text-center">
              Our 5 Pillars
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 max-w-6xl mx-auto">
              ...
              <Card className="shadow-lg h-full">
                <CardHeader>
                  ...
                  <CardTitle className="text-xl font-semibold text-[#0049ba]">
                    Professional Development
                  </CardTitle>
                </CardHeader>
                <CardContent>
